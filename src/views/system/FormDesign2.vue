  ...
  <div class="designerRoot">
    <div class="designerContentWrapper">
      ...
      <div id="palette" class="rightSide">
        <li v-for="(widget2, i) in widgetList2" :key="i">
          <label>{{ widget2.name }}</label>
        </li>
...
export default {
  ...
  methods: {
    ...
    add (event) {
      // this.widgetList2[event.newIndex].name = 'abc'
      // this.widgetList2.splice(event.newIndex, 1)
      // console.log(event)
    },
    change (event) {
      // console.log(event)
